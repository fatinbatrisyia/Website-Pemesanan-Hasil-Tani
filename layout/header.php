    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Pemesanan Produk Pertanian</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo $url ?>">Home</a></li>
            <li><a href="<?php echo $url ?>menu.php">Daftar Produk</a></li> 
        ...
        <!-- Wrapper for Slides -->
          <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/padi.jpg');"></div>
                <div class="carousel-caption">
                    <h2>Berkomitmen Membangun Pertanian Indonesia </h2>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/petani.jpg');"></div>
                <div class="carousel-caption">
                    <h2>Cintailah Produk-Produk Indonesia</h2>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/stop.jpg');"></div>
                <div class="carousel-caption">
                    <h2>Hargai Petani,STOP IMPOR!!</h2>
                </div>
            </div> 
        </div>
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="row col-md-12">
				<hr>
				<img src="<?php echo $url.'assets/img/padi.jpg'; ?>" width="100%"><br><br>
        <img src="<?php echo $url.'assets/img/cabai.jpg'; ?>" width="100%"><br><br>
        <img src="<?php echo $url.'assets/img/buah.jpg'; ?>" width="100%">
			</div>
		</div>